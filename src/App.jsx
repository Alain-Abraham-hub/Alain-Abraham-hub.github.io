...
export default function App() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-gray-200 min-h-screen">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center justify-between px-8 pt-20">
        {/* Bloch Sphere Visualization Left */}
        <div className="hidden md:flex flex-1 items-center justify-center relative w-[26rem] h-[26rem]">
        ...
        {/* Right content */}
        <div className="flex-1 md:flex-1 space-y-8">
          <div>
            <p className="text-cyan-400 text-sm mb-4 font-mono">&lt; Quantum_dev.init() /&gt;</p>
      ...
      <section id="about" className="py-32 px-8 border-t border-cyan-500/20">
        <div className="w-full">
          <div className="flex items-center gap-8 mb-16 pl-0">
          ...
          <div className="flex gap-16 items-start">
            <div className="flex-1 max-w-2xl space-y-6 text-gray-400 font-light leading-relaxed">
              <p>
                Hi, I'm <span className="text-white font-medium">Alain Abraham</span> — a tech enthusiast with a strong interest in quantum computing, full-stack development, and problem-solving. I enjoy building hands-on projects, exploring how systems work under the hood, and experimenting with new technologies.
              </p>

              <p>
                I'm especially curious about combining theory with real-world implementation, whether that's working with <span className="text-cyan-400">quantum algorithms</span> or designing clean, functional web applications. I enjoy learning continuously, improving my skills through practice, and turning ideas into solutions that are both efficient and intuitive.
              </p>
            </div>

            <div className="flex-shrink-0 -mt-8" style={{transform: 'translateX(4rem)'}}>
              <div className="relative w-72 h-72">
                <div className="absolute inset-0 bg-yellow-400/25 rounded-full blur-2xl animate-pulse"></div>
                <img
                  src="/433e0922-21cd-46bc-9d24-4222c4b2eeab.jpg"
                  alt="Alain Abraham"
                  className="relative w-full h-full rounded-full border-4 border-yellow-400/40 shadow-xl shadow-yellow-400/30 object-cover"
                />
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="flex gap-16 items-start">
            ...
            <div className="flex-shrink-0 -ml-80">
              <div className="border border-cyan-500/30 p-6 rounded">
                <div className="grid grid-cols-3 gap-4">
                  {Array(9).fill(0).map((_, idx) => (
                    <div 
                      key={idx} 
                      className="w-12 h-12 bg-blue-900/40 rounded border border-cyan-500/20 animate-blink-box"
        ...
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="flex gap-6 flex-wrap">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 border border-cyan-500/30 rounded flex items-center justify-center text-cyan-400 hover:text-cyan-300 hover:border-cyan-500/60 transition-all duration-300"
            >
            ...
            <div className="relative bg-slate-900 border border-cyan-500/40 rounded-lg shadow-2xl p-6 max-w-2xl">
              ...
              <div className="w-[600px]">
                ...
                <div className="text-center mt-4">
                  <h3 className="text-lg text-cyan-400 font-light">{projects[selectedProjectIndex]?.title}</h3>
                  <p className="text-gray-400 text-sm mt-2">{projects[selectedProjectIndex]?.desc}</p>
                </div>
              </div>
